...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_5.addWidget(self.pushButton_2, 7, 0, 1, 1)
        ...
        Dialog.setTabOrder(self.Tet_TimeRangeTo, self.pushButton_2)
        Dialog.setTabOrder(self.pushButton_2, self.Btn_PrintSupport)
